...
<div class="content container">
    ...
    <div class="row">
        ...
        <div style="margin-left: 15px;">
            <p class="p-title-big">{{ strtoupper(trans('admin.label_forgot_password')) }}</p>
        ...
        <div style="margin-top: 30px;">
            <div style="margin-left: 20px;">
                <p class="p-title-medium-blue">{{ strtoupper(trans('admin.label_retrieve_password')) }}</p>
                <p class="p-description-medium-blue">{{ trans('admin.label_retrieve_password_description') }}</p>
            </div>  
            <p>&nbsp;</p>
