    ...
    <td align='center' valign='top' style='padding:10px'>
        ...
        <tr>
        	<td valign='top'>
                ...
                <p>&nbsp;</p>
                <p>Dear {{ isset($username) ? $username : '' }},
                <br><br>The deal you submitted was successfully saved in the partner portal under My Registered Deals. </p>

                <p>The Actiontec channel partner team will review it and come back to you. Registered opportunities will typically be accepted or declined within two business days. Don't forget, the registration will remain valid for 120 days (and may be renewed). </p>
                ...
                <p>&nbsp;</p>
                <p>If you have any question about deal registration, please send an email to <a href='mailto:Deal-reg-USA@actiontec.com'>Deal-reg-USA@actiontec.com</a></p>
