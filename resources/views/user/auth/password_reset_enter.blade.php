...
<div class="content container">
    ...
    <div class="row">
        ...
        <div style="margin-left: 15px;">
            <p class="p-title-big">{{ strtoupper(trans('customer.label_reset_password')) }}</p>
        ...
        <div style="margin-top: 30px;"> 
            ...
            <div class="col-xs-12 col-sm-6 col-md-6">
                <div style="width: 80%; margin-left: 20px;">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('user/password/reset/enter') }}">
